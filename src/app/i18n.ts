    ...
    members: [
      ...
      },
      {
        ...
        bio: [
          ...
          "在联合创立 <span style=\"font-family: 'Candara', sans-serif; font-language-override: normal\">Brooklet Advisory</span> 之前，李浩担任滴灌通集团的合规事务主管 (MIC)。在此期间，他从零开始为集团的另类基金业务搭建了合规框架，并为滴灌通（澳门）金融资产交易所搭建了反洗钱/反恐怖主义融资 (AML/CFT) 架构。",
